...
export default function FloatingWidget({ onOpenBooking }: FloatingWidgetProps) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3">
      ...
      {expanded && (
        <div className="p-4 rounded-2xl bg-white shadow-2xl border border-slate-200/90 text-left space-y-3 w-64 animate-in slide-in-from-bottom-5 duration-200">
          ...
          <p className="text-[11px] text-slate-600">
            Dr. Adam & Dr. Eve available for consultations today in Sector 62 & 18.
          </p>
          ...
          <div className="space-y-2">
            ...
            >
              <Phone className="w-3.5 h-3.5 text-[#0D7A75]" /> Call: {CLINIC_INFO.phoneDemo}
            </a>
          </div>
        </div>
      )}
