...
export const CLINIC_LOCATIONS: ClinicLocation[] = [
  {
    ...
    shortName: "Sky Plaza",
    address: "SKY PLAZA, Shri Radha Sky Garden, F-25, Greater Noida West, UP 201306",
    fullAddress: "SKY PLAZA, Shri Radha Sky Garden, F-25, Greater Noida West, Uttar Pradesh 201306",
    phone: "098000 00881",
    email: "vnsn1524@gmail.com",
    rating: 5.0,
    reviewCount: 82,
    hours: {
      weekday: "9:30 AM – 12:30 PM, 5:30 PM – 8:00 PM",
      saturday: "9:30 AM – 12:30 PM, 5:30 PM – 8:00 PM",
      sunday: "Closed",
    },
  ...
  },
  {
    ...
    shortName: "Gaur City",
    address: "Aarza Square, L.G.F.-22, 7th Avenue, Gaur City 1, Sector 4, Greater Noida West, UP 201009",
    fullAddress: "Aarza Square, L.G.F.-22, 7th Avenue, Gaur City 1, Sector 4, Greater Noida West, Uttar Pradesh 201009",
    phone: "099588 81524",
    email: "vnsn1524@gmail.com",
    rating: 4.9,
    reviewCount: 118,
...
export const SERVICES: ServiceItem[] = [
  ...
  },
  {
    ...
    description: "Advanced surgical care for complex dental and facial conditions, performed by a specialist oral surgeon.",
    fullDetails:
      "Led by Dr. V.K. Saini (Lead Oral Surgeon with 15+ years of clinical experience), we perform advanced oral and maxillofacial procedures including complicated extractions, wisdom tooth surgery, jaw fracture surgery, and cyst & tumour removal — all under strict sterilization protocols with modern anesthesia techniques for maximum comfort and safety.",
    benefits: [
      "Specialist-Led Surgery by Dr. V.K. Saini (15+ Years)",
      "Complicated Extractions & Wisdom Tooth Surgery",
      "Jaw Fracture & Facial Trauma Management",
      "Cyst and Tumour Removal with Precision Diagnostics",
...
export const DOCTORS: Doctor[] = [
  {
    ...
    awards: [
      ...
      "Certification in Cleft Lip and Palate Management",
    ],
  ...
  },
  {
    ...
    qualifications: "BDS, UDMRI College (U.K.)",
    experience: "12+ Years Clinical Excellence",
    speciality: "General & Cosmetic Dentistry, Orthodontic Braces, Invisalign, Teeth Whitening, Root Canal Treatment",
    bio: "Dr. Shivani Saini earned her Bachelor of Dental Surgery (BDS) from UDMRI College (U.K.) and has spent over 12 years helping patients achieve healthy, confident smiles. She is certified in advanced restorative procedures and Invisalign, and she stays up to date on modern dental technology through continuous education. Dr. Shivani focuses on gentle, patient-centered care to ensure every visit is comfortable and stress-free. She has completed various certificate courses including root canal treatment and paediatric dentistry.",
    awards: [],
    availableDays: "Mon – Sat (Sky Plaza & Gaur City)",
    clinics: ["Sky Plaza – Greater Noida", "Gaur City – Greater Noida"],
...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    date: "May 05, 2025",
    readTime: "4 min read",
    author: "Dr. V.K. Saini (Lead Oral Surgeon)",
  ...
  },
  {
    ...
    date: "May 08, 2025",
    readTime: "5 min read",
    author: "Dr. Shivani Saini (General & Cosmetic Dentist)",
  ...
  },
  {
    ...
    date: "May 08, 2025",
    readTime: "4 min read",
    author: "Dr. V.K. Saini & Dr. Shivani Saini",
