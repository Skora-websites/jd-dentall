...
export default function PricingPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "No, all our pricing is transparent. The plan price includes all listed benefits with zero hidden charges.",
    },
    {
      q: "Can I use my plan at both clinic locations?",
      a: "Absolutely! Your membership is valid at both our Sky Plaza and Gaur City locations.",
    },
    {
      q: "Is there a family discount?",
      a: "Our Family Care plan covers up to 4 family members. Additional members get 25% discount.",
    },
  ];
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="pt-2 border-t border-slate-100">
                          ...
                          <p className="text-[11px] text-[#0D7A75] font-semibold mt-1">
                            {priceInfo.savings} • Both Greater Noida clinics
                          </p>
                        </div>
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 space-y-3">
              ...
              <p className="text-sm text-[#475569]">
                Common questions about our pricing and membership plans
              </p>
            </div>
            ...
            <div className="space-y-4">
              {faqs.map((faq, idx) => (
                <div
                  key={idx}
                  className="rounded-2xl bg-white border border-slate-200/90 p-6 hover:border-[#A3E3DF] transition-all"
                >
