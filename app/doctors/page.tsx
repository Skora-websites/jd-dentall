          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {DOCTORS.map((doc) => {
                ...
                return (
                  <Tilt3DCard key={doc.id} maxTilt={5} scale={1.02} className="h-full">
                    <div
                    ...
                    >
                      ...
                      <div className="relative h-80 sm:h-96 w-full bg-slate-100 overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-br from-[#E6F5F4] to-[#CCECE8] flex items-center justify-center">
                          <div className="text-6xl font-bold text-[#0D7A75] opacity-30">
                            {doc.name.charAt(0)}
                          </div>
                        </div>
                        <div
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-2xl mx-auto mb-12 space-y-3">
              ...
              <p className="text-sm text-[#475569]">
                Credentials and expertise that set us apart
              </p>
            </div>
              ...
              {[
                {
                  ...
                  desc: "Fellowship training from USA and Germany for world-class expertise.",
                  icon: "🌍",
                },
                {
                  title: "30+ Years Combined",
                  desc: "Over 30 years of combined clinical experience in dental surgery.",
                  icon: "⏱️",
                },
                {
                  title: "6,500+ Implants",
                  desc: "Successfully placed over 6,500 dental implants with 99.2% success rate.",
                  icon: "🦷",
                },
                {
                  title: "Invisalign Diamond",
                  desc: "Certified Diamond Provider for Invisalign clear aligners.",
                  icon: "💎",
                },
                {
                  title: "Advanced Technology",
                  desc: "Proficient with 3D CBCT, CAD/CAM, and laser dentistry.",
                  icon: "🔬",
                },
                {
                  title: "Patient-First Approach",
                  desc: "Gentle, compassionate care tailored to each patient's needs.",
                  icon: "❤️",
                },
              ].map((item, idx) => (
                <div
                  key={idx}
                  className="p-6 rounded-2xl bg-white border border-slate-200/90 shadow-sm hover:shadow-md hover:border-[#A3E3DF] transition-all group"
                >
